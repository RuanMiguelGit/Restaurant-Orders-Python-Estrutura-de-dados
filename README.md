...
# Como Funciona
<li> O projeto utilizas as estruturas de dados Dict, Hash Map, Set's</li>
<li> É possível gerar informações de uma lanchonete, para análise </li>
<li> É possível realizar análises contínuas de uma lanchonete. </li>
